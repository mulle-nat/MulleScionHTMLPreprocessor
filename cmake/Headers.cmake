...
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleScionHTMLPreprocessor-import.h")
   set( PUBLIC_HEADERS
      "src/_MulleScionHTMLPreprocessor-import.h"
      ${PUBLIC_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleScionHTMLPreprocessor-include.h")
   set( PUBLIC_HEADERS
      "src/_MulleScionHTMLPreprocessor-include.h"
      ${PUBLIC_HEADERS}
   )
endif()
...
# add ignored headers back in so that the generators pick them up
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleScionHTMLPreprocessor-import-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleScionHTMLPreprocessor-import-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleScionHTMLPreprocessor-include-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleScionHTMLPreprocessor-include-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
